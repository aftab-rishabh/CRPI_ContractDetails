...
//                 <div
//                   id="ManagementApprovalForm"
//                   className={styles.form_group}
//                   style={{ display: "block" }}
//                 >
//                   <div className={styles.sectionblock}>
//                     <Label className={styles.headers}>
//                       <u>Project Approval Form</u>
//                     </Label>
//                   </div>
...
//                       !! Below Comments Need Attention !!
//                     </Label>
//                     <br></br>

//                     <Label className={styles.Action}>Sales Comments:</Label>
//                     <br></br>
...
//                     <Label className={styles.Action}>Delivery Comments:</Label>
//                     <br></br>
//                     <div className="DeliveryHtml" id="DeliveryHtml"></div>

//                     <div className="RejectionSection">
//                       <Label className={styles.lablecontrol}>
//                         <b>Contract Rejection Comment:</b>
//                       </Label>
//                       <p style={{ color: "red" }} id="MGTComment"></p>
//                       <br></br>
//                     </div>

//                     <div id="Commercialdocs" style={{ display: "none" }}>
//                       <Label className={styles.Action}>Contract Files:</Label>
//                       <br></br>

//                       <div id="fileList4" className={styles.file_list}></div>
//                     </div>
...
//                             className={styles.errorlable}
//                           >
//                             Opportunity ID is required to upload file.
//                           </span>
//                         </div>
//                       </div>
...
//                     <br />
//                     <Label className={styles.lablecontrol}>
//                       Comments: <span className={styles.estric}>*</span>
//                     </Label>
//                     <textarea
//                       rows={4}
//                       cols={50}
...
//                         <span className={styles.close} id="Close2">
//                           &times;
//                         </span>
//                         <Label className={styles.headerZ}>
//                           Delivery Team has submitted their feedback after you
//                           opened this page. Webpage needs to be refreshed to
//                           view latest feedback. Thank you.
//                         </Label>
//                       </div>
//                     </div>
...
//                       <div className={styles.modalcontent}>
//                         <span className={styles.close} id="Close3">
//                           &times;
//                         </span>
//                         <Label className={styles.headerZ}>
//                           Technical Team has submitted their feedback after you
//                           opened this page. Webpage needs to be refreshed to
//                           view latest feedback. Thank you
//                         </Label>
//                       </div>
...
//       .then((data) => {
//         if (
//           data.Status === "Management Action Awaited" ||
//           data.Status == "Escalated to management" ||
//           data.Status == "Delivery Action Awaited"
//         ) {
//           document.getElementById("ManagementApprovalTaskForm").style.display =
//             "block";
...
//           if (
//             data.MgtComments != null &&
//             data.MgtComments != "" &&
//             data.MgtComments != undefined
//           ) {
...
//         (document.getElementById("fileList4") as HTMLInputElement).innerHTML =
//           attachmentfiles;
...
//     const htmlElement = document.getElementById("#fileList4");
...
//     let web = Web(this.props.webURL);
//     await web.lists
//       .getByTitle("SalesFeedback")
//       .items.filter(fltrStrSales)
//       .get()
//       .then((item) => {
//         if (item.length !== 0) {
//           for (var j = 0; j < item.length; j++) {
//             if (
//               item[j].Requirement == "IfNoComment" &&
//               item[j].Comment !== null
//             ) {
//               var html2 = "";
//               html2 +=
...
//                 '<lable class="' +
//                 viewanswer +
//                 '" style="color:red" id="Techcomment' +
//                 item[j].ID +
//                 '">' +
//                 item[j].Comment +
//                 "</lable>" +
...
//             if (
//               item[j].Requirement == "IfYesComment" &&
//               item[j].Comment !== null
//             ) {
//               var htmla = "";
//               htmla +=
...
//     const itemID = new URLSearchParams(window.location.search).get("itemid");
//     var fltrStrSales =
//       "ProjectID eq '" + itemID + "' and " + "QuestionNumber eq 'DEL1'";
//     if ($("#MgtComments").val() === "") {
//       $("#MgtErr").show();
//       isvalid = false;
//     } else $("#MgtErr").hide();
...
//               web
//                 .getFolderByServerRelativeUrl(hostUrl)
//                 .files.add(encodeURIComponent(file.name), file, true)
//                 .then((f) => {
...
//             }
//           }
//           (document.getElementById("FileList2") as HTMLInputElement).innerHTML =
//             attachmentfiles;
//         }
//       })
//       .then((noF) => {
...
//             var DateModified = moment(items1[0].Modified).format(
//               "YYYY-MM-DDTHH:mm:ss"
//             );
...
//                 var DateModified = moment(items1[t].Modified).format(
//                   "YYYY-MM-DDTHH:mm:ss"
//                 );
//                 var ManagementOpenTime = moment().diff(OpenTime, "seconds");
//                 var TechnicalUpdateTime1 = moment().diff(
//                   DateModified,
//                   "seconds"
//                 );
//                 var TechnicalUpdateTime2 = TechnicalUpdateTime1 + 60;
//                 if (
//                   ManagementOpenTime < TechnicalUpdateTime2 &&
//                   isvalid !== false
//                 ) {
//                   isvalid = true;
...
//           "ProjectID eq '" +
//           itemID +
//           "' and Status eq 'In-Progress' and " +
//           "TaskType eq 'Management/Marketing'";
//         web.lists
...
> {
  ...
  private onRichTextChange(newValue: string): string {
    console.log("Onchange called: "+ newValue);
    this.setState({ MgmtCommentVal: newValue });
    return newValue;
  }
              ...
              <div className="col-lg-12">
                ...
                >
                  ...
                  <div className="NoComments" id="NoComments">
                    ...
                    <div id="MgmtCommentDiv" className={styles.richTextContainer} >
                      <RichText 
                      className="MgmtCommentElement"
                      value={this.state.MgmtCommentVal} 
                      onChange={(newtext) => this.onRichTextChange(newtext)}
                      />
                      </div>
  ...
  private async MgtReject() {
    ...
    var isvalid = true;
    const itemID = new URLSearchParams(window.location.search).get("itemid");
    if (this.state.MgmtCommentVal.replace(/<\/?[^>]+(>|$)/g, "").replace(/&nbsp;/g, "").trim().length === 0) {
      $("#MgtErr").show();
      isvalid = false;
    } else $("#MgtErr").hide();
    if (isvalid) {
      ...
      await web.lists
        ...
        .items.getById(parseInt(itemID))
        .update({
          MgtComments: this.state.MgmtCommentVal,
          Status: "Rejected to Sales",
          TechnicalDone: 2,
          DeliveryDone: 2,
        })
