...
export class PmActionWebPart extends React.Component<
  IPmActionProps,
  IPmActionState
> {
  [x: string]: any;
  ...
  public async componentDidMount() {
    ...
    this.relativeUrl = this.props.context.pageContext.site.serverRelativeUrl;
    this.setForm();
    this.viewItem();
  }
                ...
                <div id="ProjectDetails" style={{ display: "block" }}>
                  ...
                  <div className="row ${styles.sectionEnd}">
                    <div className="col-md-6 ${styles.form_group}">
                      <Label className={styles.lablecontrol}>
                        Sprint Duration:<span className={styles.estric}>*</span>
                      </Label>
                      <input
                        className={styles.form_control}
                        type="text"
                        placeholder="SprintDuration"
                        id="SprintDuration"
                      ></input>
                      <Label
                        className={styles.errorlable}
                        id="SprintDurationErr"
                        style={{ display: "none" }}
                      >
                    ...
                    <div className="col-md-6 ${styles.form_group}">
                      ...
                      <input
                        className={styles.form_control}
                        type="text"
                        placeholder="ProjectInitiationDuration"
                        id="ProjectInitiationDuration"
                      ></input>
                      <Label
                        className={styles.errorlable}
                        id="ProjectInitiationDurationErr"
                        style={{ display: "none" }}
                      >
                        This field is required.
                      </Label>
                  ...
                  <div id="ClientAndBilling" style={{ display: "block" }}>
                    ...
                    <div className="row ${styles.sectionEnd}">
                      ...
                      >
                        <div style={{ border: "0" }}>
                          <table className="table" id="dataTable" width="60%">
                            <tr>
                              <th className={styles.ThH}>
                                Payment Milestone Name (Phase)
                              </th>
                              <th className={styles.ThH}>
                  ...
                  <div id="DeliveryCommitments" style={{ display: "block" }}>
                    ...
                    <h4 className={styles.subheading4}>
                      3.1 Project Timelines By PMO By Referring Contract{" "}
                    </h4>
                    ...
                    <div className={styles.sectionEnd}>
                      ...
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 1: Start Date Cannot Be Older Than Today's
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 2: Start Date Cannot Be Older Than Today's
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 3: Start Date Cannot Be Older Than Today's
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 4: Start Date Cannot Be Older Than Today's
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 5: Start Date Cannot Be Older Than Today's
                          Date.
                        </Label>
                      </div>
                      ...
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 1: End Date Cannot Be Older Than Start
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 2: End Date Cannot Be Older Than Start
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 3: End Date Cannot Be Older Than Start
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 4: End Date Cannot Be Older Than Start
                          Date.
                        </Label>
                      </div>
                      <div>
                        <Label
                          ...
                          style={{ display: "none" }}
                        >
                          Deliverable 5: End Date Cannot Be Older Than Start
                          Date.
                        </Label>
                      </div>
                      ...
                      <Label
                        ...
                        style={{ display: "none" }}
                      >
                        Atleast One Deliverable should be present.
                      </Label>
                    </div>
                    ...
                    <div id="SubmittedModal" className={styles.modal}>
                      <div className={styles.modalcontent}>
                        ...
                        <Label className={styles.header2}>
                          PI Note details submitted!
                        </Label>
                      </div>
                    </div>

                    <h4 className={styles.subheading4}>
                      Client Provided Documents and Artefacts:
                    </h4>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-5">
                        <div className="form-group">
                          <Label className={styles.lablecontrol}>
                            Attachment:<span className={styles.estric}>*</span>
                          </Label>
                          <input
                            type="file"
                            className={styles.form_control}
                      ...
                      <div className="col-lg-12">
                        <div className={styles.form_footer}>
                          ...
                          <PrimaryButton
                            ...
                            id="Cancel"
                            onClick={() => this.CancelInitiateProject()}
                          ></PrimaryButton>
                        </div>
                      </div>
                    </div>
  ...
  private getPaymentMilestone() {
    ...
    this.webURL.lists
      .getByTitle("PaymentMileStoneTable")
      .items.filter("Title eq " + itemID)
      .getAll()
      .then((milestone) => {
        if (milestone.length > 0) {
          ...
          milestonetbl +=
            '<tr id="TR1">' +
            '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone1">' +
            milestone[0].PaymentMilestone1 +
            "</lable></td>" +
            '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate1">' +
            milestone[0].MilestoneDate1 +
            "</lable></td>" +
            '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage1">' +
            milestone[0].Percentage1 +
            "</lable></td>" +
            "</tr>";
          if (
            milestone[0].PaymentMilestone2 != null &&
            milestone[0].PaymentMilestone2 != ""
          ) {
            milestonetbl +=
              '<tr id="TR2">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone2">' +
              milestone[0].PaymentMilestone2 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate2">' +
              milestone[0].MilestoneDate2 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage2">' +
              milestone[0].Percentage2 +
              "</lable></td>" +
              "</tr>";
          }
          if (
            milestone[0].PaymentMilestone3 != null &&
            milestone[0].PaymentMilestone3 != ""
          ) {
            milestonetbl +=
              '<tr id="TR3">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone3">' +
              milestone[0].PaymentMilestone3 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate3">' +
              milestone[0].MilestoneDate3 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage3">' +
              milestone[0].Percentage3 +
              "</lable></td>" +
              "</tr>";
          }
          if (
            milestone[0].PaymentMilestone4 != null &&
            milestone[0].PaymentMilestone4 != ""
          ) {
            milestonetbl +=
              '<tr id="TR4">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone4">' +
              milestone[0].PaymentMilestone4 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate4">' +
              milestone[0].MilestoneDate4 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage4">' +
              milestone[0].Percentage4 +
              "</lable></td>" +
              "</tr>";
          }
          if (
            milestone[0].PaymentMilestone5 != null &&
            milestone[0].PaymentMilestone5 != ""
          ) {
            milestonetbl +=
              '<tr id="TR5">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone5">' +
              milestone[0].PaymentMilestone5 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate5">' +
              milestone[0].MilestoneDate5 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage5">' +
              milestone[0].Percentage5 +
              "</lable></td>" +
              "</tr>";
          }
          if (
            milestone[0].PaymentMilestone6 != null &&
            milestone[0].PaymentMilestone6 != ""
          ) {
            milestonetbl +=
              '<tr id="TR6">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone6">' +
              milestone[0].PaymentMilestone6 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate6">' +
              milestone[0].MilestoneDate6 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage6">' +
              milestone[0].Percentage6 +
              "</lable></td>" +
              "</tr>";
          }
          if (
            milestone[0].PaymentMilestone7 != null &&
            milestone[0].PaymentMilestone7 != ""
          ) {
            milestonetbl +=
              '<tr id="TR7">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone7">' +
              milestone[0].PaymentMilestone7 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate7">' +
              milestone[0].MilestoneDate7 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage7">' +
              milestone[0].Percentage7 +
              "</lable></td>" +
              "</tr>";
          }
          if (
            milestone[0].PaymentMilestone8 != null &&
            milestone[0].PaymentMilestone8 != ""
          ) {
            milestonetbl +=
              '<tr id="TR8">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone8">' +
              milestone[0].PaymentMilestone8 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate8">' +
              milestone[0].MilestoneDate8 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage8">' +
              milestone[0].Percentage8 +
              "</lable></td>" +
              "</tr>";
          }

          if (
            milestone[0].PaymentMilestone9 != null &&
            milestone[0].PaymentMilestone9 != ""
          ) {
            milestonetbl +=
              '<tr id="TR9">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone9">' +
              milestone[0].PaymentMilestone9 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate9">' +
              milestone[0].MilestoneDate9 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage9">' +
              milestone[0].Percentage9 +
              "</lable></td>" +
              "</tr>";
          }
          if (
            milestone[0].PaymentMilestone10 != null &&
            milestone[0].PaymentMilestone10 != ""
          ) {
            milestonetbl +=
              '<tr id="TR10">' +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="PaymentMilestone10">' +
              milestone[0].PaymentMilestone10 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="MilestoneDate10">' +
              milestone[0].MilestoneDate10 +
              "</lable></td>" +
              '<td><lable style="width: 100%; text-align:center; display:inline-block"  id="Percentage10">' +
              milestone[0].Percentage10 +
              "</lable></td>" +
              "</tr>";
          }
        }
      ...
      .then(() => {
        for (let x = 0; x < 10; x++) {
          let PM = "PaymentMilestone" + (x + 1);
          let tr = "TR" + (x + 1);
          let NullDateId = "MilestoneDate" + (x + 1);
          let nulltxt = document.getElementById(PM).innerText;
          let nullDate = document.getElementById(NullDateId).innerText;
    ...
    this.webURL.lists
      ...
      .then((data) => {
        ...
        if (data.Status == "PM Action Awaited") {
          document.getElementById("pm-action-awaited-buttons").style.display =
            "block";
        }
  ...
  private UploadFiles() {
    ...
    let OID = $("#oppID")[0].innerHTML;

    if ($("#DocType").val() == "") {
      $("#DocTypeErr").show();
      isvalid = false;
    } else $("#DocTypeErr").hide();

    if (isvalid) {
      let files = (document.getElementById("file") as HTMLInputElement).files;
      if (files.length !== 0) {
        $("#fileErr1").hide();
        this.webURL.folders
          .getByName("ProjectDocuments")
          .folders.add(OID)
          .then((data) => {})
          .then((b) => {
            let fileArr = [];
            for (let g = 0; g < files.length; g++) {
              ...
              let hostUrl = this.relativeUrl + "/ProjectDocuments/" + OID;
      ...
      .then((files) => {
        if (files.length == 0) {
          ...
          for (let i = 0; i < files.length; i++) {
            ...
            if (
              files[i].Title != "Management" &&
              files[i].Title != "Estimation file" &&
              files[i].Title != "Others" &&
              files[i].Title != "Legal Documents File" &&
              files[i].Title != "Project Related Document from CM" &&
              files[i].Title != "Kick-off document" &&
              files[i].Title != "Contract - Commercial"
            ) {
              let Uid = "DeleteFile" + files[i].UniqueId;
              ...
              attachmentfiles +=
                ...
                `${files[i].Name}</a></li>`;
              (
                document.getElementById("FileList2") as HTMLInputElement
  ...
  private viewItem(): void {
    ...
    this.webURL.lists
      .getByTitle("Projects")
      .items.getById(parseInt(itemID))
      .select("*", "Description", "ProjectType", "ProjectManager/Title")
      .expand("ProjectManager/Id")
      .get()
      .then((item) => {
        let PT = item.PrimaryTechnology;
        let pt = [];
  ...
  private InitiateProject() {
    ...
    if (
      $("#EngagementType")[0].innerHTML == "Fixed Price" &&
      $("#DeliverableName1").val() === ""
    ) {
...
/*
    ...
    let datetd = moment(new Date()).format("YYYY-MM-DD");

    let datest1 = moment($("#WeekDate1").val()).format("YYYY-MM-DD");
    let datest2 = moment($("#WeekDate2").val()).format("YYYY-MM-DD");
    let datest3 = moment($("#WeekDate3").val()).format("YYYY-MM-DD");
    let datest4 = moment($("#WeekDate4").val()).format("YYYY-MM-DD");
    let datest5 = moment($("#WeekDate5").val()).format("YYYY-MM-DD");

    let datest11 = moment($("#WeekDate11").val()).format("YYYY-MM-DD");
    let datest22 = moment($("#WeekDate22").val()).format("YYYY-MM-DD");
    let datest33 = moment($("#WeekDate33").val()).format("YYYY-MM-DD");
    let datest44 = moment($("#WeekDate44").val()).format("YYYY-MM-DD");
    let datest55 = moment($("#WeekDate55").val()).format("YYYY-MM-DD");

    if (datest1 < datetd) {
      $("#StartDateErr1").show();
      $("#WeekDate1").focus();
      isvalid = false;
    } else $("#StartDateErr1").hide();

    if (datest2 < datetd) {
      $("#StartDateErr2").show();
      $("#WeekDate2").focus();
      isvalid = false;
    } else $("#StartDateErr2").hide();

    if (datest3 < datetd) {
      $("#StartDateErr3").show();
      $("#WeekDate3").focus();
      isvalid = false;
    } else $("#StartDateErr3").hide();

    if (datest4 < datetd) {
      $("#StartDateErr4").show();
      $("#WeekDate4").focus();
      isvalid = false;
    } else $("#StartDateErr4").hide();

    if (datest5 < datetd) {
      $("#StartDateErr5").show();
      $("#WeekDate5").focus();
      isvalid = false;
    } else $("#StartDateErr5").hide();
    ...
    */
    ...
    if (datest11 < datest1) {
      ...
      $("#WeekDate1").focus();
      isvalid = false;
    } else $("#EndDateErr1").hide();

    if (datest22 < datest2) {
      $("#EndDateErr2").show();
      $("#WeekDate2").focus();
      isvalid = false;
    } else $("#EndDateErr2").hide();

    if (datest33 < datest3) {
      $("#EndDateErr3").show();
      $("#WeekDate3").focus();
      isvalid = false;
    } else $("#EndDateErr3").hide();

    if (datest44 < datest4) {
      $("#EndDateErr4").show();
      $("#WeekDate4").focus();
      isvalid = false;
    } else $("#EndDateErr4").hide();

    if (datest55 < datest5) {
      $("#EndDateErr5").show();
      $("#WeekDate5").focus();
      isvalid = false;
    } else $("#EndDateErr5").hide();
  ...
  private InitiateProject2(): void {
    const itemID = new URLSearchParams(window.location.search).get("itemid");
    let filterStr = "ItemId eq '" + itemID + "'";
    this.webURL.lists
      .getByTitle("PINote")
      ...
      .then((data) => {
        if (data.length) {
          ...
          this.webURL.lists
            .getByTitle("PINote")
            .items.getById(parseInt(itemID1))
            .update({
            ...
            .then((i) => {
              this.webURL.lists
                ...
                .items.add({
                  ...
                  TaskType: "PM - PM Action Awaited",
                })
                .then((j) => {
                  const itemID2 = new URLSearchParams(
                    window.location.search
                  ).get("itemid");
                  this.webURL.lists
                    .getByTitle("Projects")
                    .items.getById(parseInt(itemID2))
                    .update({
