...
> {
      ...
      .then((i) => {
        this.webURL.lists
          ...
          .items.add({
            ...
            TaskType: "CM - CM Documents Upload Awaited",
          })
          .then((j) => {
            this.webURL.lists
              .getByTitle("Projects")
  ...
  private getFiles1(): void {
    ...
    var hostUrl = this.relativeUrl + "/ProjectDocuments/" + $("#oppID").text();
    this.webURL
      .getFolderByServerRelativeUrl(hostUrl)
