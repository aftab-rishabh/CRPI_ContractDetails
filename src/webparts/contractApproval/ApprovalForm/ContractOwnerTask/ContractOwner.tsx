...
export class ContractOwner extends React.Component<
  IContractOwnerProps,
  IContractOwnerState
> {
  ContractStatus = "";
              ...
              <div className="panel-body" style={{ paddingTop: "0px" }}>
                <div className="row">
                  <div className={styles.sectionblockContractOwner}>
                    <Label className={styles.headersContractOwner}>
                      <u>Contract Owner Form</u>
                    </Label>
                  </div>

                  <div className="col-lg-12">
                    <div className={styles.form_group}>
                      <Label id="Question" className={styles.lablecontrol}>
                ...
                <div id="withContractBlock">
                  <div className="row">
                    <div className="col-lg-12">
                      <div className={styles.form_group}>
                        ...
                        <textarea
                          name="DetailsOfAmendment"
                          className={styles.form_control}
                          id="DetailsOfAmendment"
                          placeholder="Details of Amendment"
                        ></textarea>
                        <Label
                          id="DetailsOfAmendmentErr"
                          style={{
                            display: "none",
                            fontSize: "x-small",
                            color: "red",
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <div className={styles.form_group}>
                        <Label className={styles.lablecontrol}>
                          Is the Contract without any amendments?{" "}
                        </Label>
                        <select
                          id="WithoutAnyAmendments"
                          onChange={() => this.amendmentsChange()}
                          className={styles.form_control}
                        >
                          <option>Yes</option>
                          <option>No</option>
                  ...
                  <div className="row">
                    <div
                      className="col-lg-12"
                      style={{ display: "none" }}
                      id="AmendmentCommentdiv"
                    >
                      <div className={styles.form_group}>
                        <Label className={styles.lablecontrol}>
                          Comment:<span className={styles.estric}>*</span>
                        </Label>
                        <textarea
                          rows={4}
                          cols={50}
                          name="AmendmentComment"
                          className={styles.form_control}
                          id="AmendmentComment"
                          placeholder="Comment"
                        ></textarea>
                        <Label
                          id="AmendmentCommentErr"
                          style={{
                            display: "none",
                            fontSize: "x-small",
                            color: "red",
                ...
                <div id="withoutContractBlock" style={{ display: "none" }}>
                  <div className="row">
                    <div className="col-lg-12">
                      <div className={styles.form_group}>
                        <Label className={styles.lablecontrol}>
                          Key pointers to start the project without contract:{" "}
                          <span className={styles.estric}>*</span>
                        </Label>
                        <textarea
                          rows={4}
                          cols={50}
                          name="KeyPointersToStWithoutContract"
                          className={styles.form_control}
                          id="KeyPointersToStWithoutContract"
                          placeholder="Key Pointers"
                        ></textarea>
                        <Label
                          id="KeyPointersToStWithoutContractErr"
                          style={{
                            display: "none",
                            fontSize: "x-small",
                            color: "red",
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <div className={styles.form_group}>
                        <Label className={styles.lablecontrol}>
                          Due date until contract gets signed:{" "}
                          <span className={styles.estric}>*</span>
                        </Label>
                        <div
                        ...
                        >
                          <input
                            type="date"
                            className={styles.form_control}
                            id="ExpectedContractSignDueDt"
                            name="txtDate"
                            placeholder="DD/MM/YYYY"
                          ></input>
                        </div>
                        <Label
                          id="ExpectedContractSignDueDtErr"
                          style={{
                            display: "none",
                            fontSize: "x-small",
                            color: "red",
                        ...
                        <Label
                          id="ExpectedContractSignDueDtErr2"
                          style={{
                            display: "none",
                            fontSize: "x-small",
                            color: "red",
                  ...
                  <div id="UnSignedSubmitModal" className={styles.modal}>
                    <div className={styles.modalcontent}>
                      ...
                      <Label className={styles.headerZ}>
                        Key-pointers are sent to management for approval!
                      </Label>
                    </div>
                  </div>
  ...
  private Submit1() {
    ...
    if (
      $("#answer1:checked").val() !== undefined &&
      $("#DetailsOfAmendment").val() === ""
    ) {
      $("#DetailsOfAmendmentErr").show();
      isvalid = false;
    } else $("#DetailsOfAmendmentErr").hide();

    if (
      $("#answer1:checked").val() !== undefined &&
      $("#AmendmentComment").val() === "" &&
      $("#WithoutAnyAmendments").val() == "No"
    ) {
      $("#AmendmentCommentErr").show();
      isvalid = false;
    } else $("#AmendmentCommentErr").hide();
      ...
      .then((i) => {
        ...
        web.lists
          ...
          .items.add({
            ...
            TaskType: "CM - Approved PI Workflow Awaited",
          })
          .then((newListItem) => {
            $("#loader1").show();
            setTimeout(() => {
  ...
  private Submit2() {
    ...
    if (
      $("#answer2:checked").val() !== undefined &&
      $("#KeyPointersToStWithoutContract").val() === ""
    ) {
      $("#KeyPointersToStWithoutContractErr").show();
      isvalid = false;
    } else $("#KeyPointersToStWithoutContractErr").hide();

    if (
      $("#answer2:checked").val() !== undefined &&
      $("#ExpectedContractSignDueDt").val() === ""
    ) {
      $("#ExpectedContractSignDueDtErr").show();
      isvalid = false;
    } else $("#ExpectedContractSignDueDtErr").hide();

    var datest = moment($("#ExpectedContractSignDueDt").val()).format(
      "YYYY-MM-DD"
    );
    ...
    if ($("#answer2:checked").val() !== undefined && datest < datetd) {
      ...
      isvalid = false;
    } else $("#ExpectedContractSignDueDtErr2").hide();
  ...
  private UnSignedSubmit() {
    ...
    this.webURL.lists
      ...
      .update({
        ...
        KeyPointersToStWithoutContract: $(
          "#KeyPointersToStWithoutContract"
        ).val(),
    ...
    this.webURL.lists
      ...
      .then((data) => {
        if (data.Status === "Approved PI Workflow Awaited") {
          document.getElementById("signedContractDecission").style.display =
            "block";
