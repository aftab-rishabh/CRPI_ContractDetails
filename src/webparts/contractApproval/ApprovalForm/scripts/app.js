    ...
    withSPContext: function (action) {
        ...
        if ($app.getContextPromise == null) {
            $app.getContextPromise = $.Deferred(function (def) {
                ...
                var hostUrl = location.href.split("/")[0]+'/'+location.href.split("/")[1]+'/'+location.href.split("/")[2]+'/'+location.href.split("/")[3]+'/'+location.href.split("/")[4];
                var appWebUrl =location.href.split("/")[0]+'/'+location.href.split("/")[1]+'/'+location.href.split("/")[2]+'/'+location.href.split("/")[3]+'/'+location.href.split("/")[4];
