...
export default class ContractApproval extends React.Component<IContractApprovalProps, {}> {
  public render(): React.ReactElement<IContractApprovalProps> {
    ...
    return (
      <section className={`${styles.contractApproval} ${hasTeamsContext ? styles.teams : ''}`}>
