                      ...
                      onClick={(e) => {
                        if (this.Status == "Technical Action Awaited") {
                          ...
                          this.setState({ btnTechnicalTask: true, btnSales: true, TechnicalTask: true,LegalFeedback:true });
                            ...
                            this.setState({ btnLegalTask: true, LegalFeedback:true,btnSales: true, btnTechnicalTask: true});
                          }
                        this.setState({
                          ContractOwner: false,
                          Sales: false,
                  ...
                  <div>
                    <DefaultButton
                      ...
                      onClick={(e) => {
                        if (this.Status == "Technical Action Awaited") {
                          if(this.Action=="Legal"){
                            this.setState({ btnLegalTask: true, LegalTask:false,btnSales: true, btnTechnicalTask: true,TechnicalFeedback:true});
                          }else{
                          ...
                          if (this.Dpt != null) {
                            ...
                            this.setState({ btnLegalTask: true,LegalTask:false,btnManagement: false, btnSales: true,btnTechnicalTask: true,btnDeliveryTask:true,TechnicalFeedback: true });
                          }
                          else {
                          ...
                          if (this.Dpt != null) {
                            ...
                            this.setState({ btnLegalTask: true,btnManagement: false, btnSales: true,btnTechnicalTask: true,btnDeliveryTask:true,TechnicalFeedback: true  });
                          }
                    ...
                    <DefaultButton
                      ...
                      onClick={(e) => {
                        if (this.Status == "Delivery Action Awaited") {
                          if(this.Action=="Legal"){
                            this.setState({ btnLegalTask: true,LegalTask:false,DeliveryFeedback:true,btnManagement: false, btnSales: true,btnTechnicalTask: true,btnDeliveryTask:true  });
                          }else{
            ...
            <div className={styles.section_right}>
              ...
              {this.state.CMDocUpload && (
               ...
               {this.state.ManagementConsentTask && (
                <ManagementConsentTask webURL={this.props.webURL}></ManagementConsentTask>
              )}
      ...
      .then(async (item) => {
        ...
        if (this.currentuseremail.toLowerCase() == this.CreatedEmail.toLowerCase()) {
          if (item.Status == "Technical Action Awaited") {
            ...
            if (this.Dpt != null || this.Action=="Legal" || this.Action == "Delivery") {
              this.setState({ btnContractOwner: false,ContractOwner:false ,btnSales: true, btnTechnicalTask: true,btnLegalTask:true,btnDeliveryTask: true,});
            }else{
            this.setState({ btnContractOwner: true,ContractOwner:true ,btnSales: true, btnTechnicalTask: true,btnLegalTask:true,btnDeliveryTask: true,});
            }
          } 
          else if (item.Status == "Management Approval Awaited to Start Without Signed Contract") {
            this.setState({btnManagementConsentTask: true,ManagementConsentTask:true,btnSales: true, btnTechnicalTask: true,btnLegalTask:true,btnDeliveryTask: true,});
          
          }
          else if (item.Status == "CM Documents Upload Awaited") {
            this.setState({btnCMDocUpload: true,CMDocUpload:true,btnSales: true, btnTechnicalTask: true,btnLegalTask:true,btnDeliveryTask: true,});
          
          } else if (item.Status == "PM Assignment Awaited") {
          
            this.setState({btnPmAssign: true,PmAssign:true,btnSales: true, btnTechnicalTask: true,btnLegalTask:true,btnDeliveryTask: true,});
          
          } else if (item.Status == "PM Action Awaited") {
            this.setState({btnPmAction: true,PmAction:true,btnSales: true, btnTechnicalTask: true,btnLegalTask:true,btnDeliveryTask: true,});
          
          } else if (item.Status == "Kickoff Docs Awaited") {            
            this.setState({btnKickOffDocUpload: true,KickOffDocUpload:true,btnSales: true, btnTechnicalTask: true,btnLegalTask:true,btnDeliveryTask: true,});
