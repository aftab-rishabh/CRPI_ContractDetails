...
export class KickOffDocUpload extends React.Component<IKickOffDocUploadProps, IKickOffDocUploadState> {
  [x: string]: any;
          ...
          <div className={styles.row} style={{ paddingTop: '0px' }}>
            ...
            <div id="kickoffdocs" style={{ display: 'none' }}>
              <div className={styles.sectionblockPMAction}>
                <Label className={styles.headersPMAction} style={{ marginTop: '0px' }}><u>Kick-off Document Upload Form</u></Label>
              </div>
              ...
              <div id="" className="row">
                <div className="col col-md-6 ${styles.form_group}">
                  ...
                  <div className={styles.mb_1}><PrimaryButton className="fileUpload-Button ${styles.btn} btn-primary" onClick={() => this.uploadFileFromControl()} >
                    <span>Upload</span>
                  </PrimaryButton>
                  </div>
            ...
            <div className="row">
              ...
              <div className={styles.form_footer}>
                <PrimaryButton text="Initiate Project" style={{ borderRadius: "10px",marginRight:"10px" }} className={styles.btn} id="Submit" onClick={() => this.KickoffDocsUploded()}></PrimaryButton>
                </div>
  ...
  private KickoffDocsUploded(): void {
    ...
    web.getFolderByServerRelativeUrl(hostUrl).files.filter("Title eq 'Kick-off document'").get().then(files => {
      if (files.length !== 0) {
        $("#fileErr1").hide();
      ...
      if (files.length == 0) {
        ...
        for (var i = 0; i < files.length; i++) {
          ...
          attachmentfiles += `<li id="FileListItem` + i + `" value=` + valu + `><button class="CloseBtn"`
            ...
            + `${files[i].Name}</a></li>`;
            (document.getElementById('KickOfffileList') as HTMLInputElement).innerHTML = attachmentfiles;
