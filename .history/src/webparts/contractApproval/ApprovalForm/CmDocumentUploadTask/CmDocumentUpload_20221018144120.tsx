...
export class CmDocumentUpload extends React.Component<ICmDocumentUploadProps, ICmDocumentUploadState> {
  [x: string]: any;
  ...
  public render(): React.ReactElement<ICmDocumentUploadProps> {
      ...
      <div className={styles.cmDocumentUpload}>
        <div className={styles.container}>
          <div className={styles.row} style={{ paddingTop: '0px' }}>
            ...
            <div className={styles.pagetitle_wrap} style={{ marginBottom: '0px' }}>
              <div id="status" className="status ${styles.pagetitle}"></div>
              <div id="oppID" style={{ display: 'none' }} className="oppID ${styles.pagesubtitle}"></div>
            </div>
            ...
            <div id="cm-documents-upload-awaited-buttons" >
              <div id="ProjectDetails" style={{ display: 'inline-block' }} >
                <div className={styles.sectionblockCMPI}>
                  <Label className={styles.headersCMPI} style={{ marginTop: '0px' }}><u>PI Note Details Form</u></Label>
                </div>
                        ...
                        <div className={styles.view_listing}>
                          <ul>
                            <li>
                              ...
                              <div className={styles.viewlable_info} id="ProjectName"> </div>
                            </li>
                            <li>
                              <div className={styles.viewlable}>Short Name:</div>
                              <div className={styles.viewlable_info} id="ShortName"> </div>
                            </li>
                            <li>
                              <div className={styles.viewlable}>Client Organization:</div>
                              <div className={styles.viewlable_info} id="ClientOrganisation"> </div>
                            </li>
                            <li>
                              <div className={styles.viewlable}>Estimated Hours:</div>
                              <div className={styles.viewlable_info} id="EstimatedHours"> </div>
                            </li>
                            <li>
                              <div className={styles.viewlable}>Industry:</div>
                              <div className={styles.viewlable_info} id="Industry"> </div>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className={styles.view_listing}>
                          <ul>
                            <li>
                              ...
                              <div className={styles.viewlable_info} id="StartDate"> </div>
                            </li>
                            <li>
                              <div className={styles.viewlable}>End Date:</div>
                              <div className={styles.viewlable_info} id="EndDate"> </div>
                            </li>
                            <li>
                              <div className={styles.viewlable}>Project Type:</div>
                              <div className={styles.viewlable_info} id="ProjectType"> </div>
                            </li>
                            <li>
                              <div className={styles.viewlable}>Practice:</div>
                              <div className={styles.viewlable_info} id="Practice"> </div>
                            </li>
                            <li>
                ...
                <div className="row">
                  ...
                  <div className={styles.form_group}>
                    <Label className={styles.lablecontrol}>Approved Hours:<span className={styles.estric}>*</span>
                    </Label>
                    <input className={styles.form_control} type="number" placeholder="Approved Hours"
                      id="ApprovedHours"></input>
                    <Label className={styles.errorlable} id="ApprovedHoursErr" style={{ display: 'none' }}
                    >This field is required.</Label>
                  </div></div>
                  <div className="col-md-6">
                  <div className={styles.form_group}>
                    <Label className={styles.lablecontrol}>Comments For Hours Difference:<span
                      className={styles.estric} id="Just" style={{ display: 'inline' }}>*</span></Label>
                    <textarea className={styles.form_control} placeholder="Comments" rows={2} cols={50}
                      id="Justification"></textarea>
                    <Label className={styles.errorlable} id="JustificationErr" style={{ display: 'none' }}
                    >This field is required.</Label>
                  </div></div>
                </div>
                ...
                <div className="row ${styles.sectionEnd}">
                  ...
                  <div className="col-md-6">
                    <div className={styles.form_group}>
                      <Label className={styles.lablecontrol}>Contract Date: <span className={styles.estric}>*</span>
                      </Label>
                      <input type="date" className={styles.form_control} id="ContractDate" ></input>
                      <Label className={styles.errorlable} id="ContractDateErr" style={{ display: 'none' }}
                      >This field is required.</Label>
                    </div></div>
                </div><br></br>
                  ...
                  <div className="col-lg-12 ">
                    <div className={styles.viewdetail_block}>
                      <div className={styles.view_listing}>
                        <ul>
                          <li>
                            <div className={styles.viewlable}>Technology-Primary:</div>
                            <div className={styles.viewlable_info} id="Technology-Primary"> </div>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-12 ">
                    <div className={styles.viewdetail_block}>
                      <div className={styles.view_listing}>
                        <ul>
                          <li>
                            <div className={styles.viewlable}>Technology-Secondary:</div>
                            <div className={styles.viewlable_info} id="Technology-Secondary"> </div>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className={styles.form_group}>
                      <Label className={styles.lablecontrol}>Order No.: <span className={styles.estric}>*</span>
                      </Label>
                      <input type="text" placeholder="OrderNo" id="OrderNo"
                        className={styles.form_control} disabled></input>
                      <Label className={styles.errorlable} id="OrderNoErr" style={{ display: 'none' }}
                      >This field is required.</Label>
                      <span id="OrderNoErr2" style={{ display: 'none' }} className={styles.errorlable}
                      >Contract
                        for this Order Number Exists.</span>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className={styles.form_group}>
                      <Label className={styles.lablecontrol}>Contract No.: <span className={styles.estric}>*</span>
                      </Label>
                      <input type="text" placeholder="ContractNo" id="ContractNo"
                        className={styles.form_control} disabled></input>
                      <Label className={styles.errorlable} id="ContractNoErr" style={{ display: 'none' }}
                      >This
                        field is
                        required.</Label>
                      <span id="ContractNoErr2" style={{ display: 'none' }} className={styles.errorlable}
                      >Contract for this Contract Number Exists.</span>
                          ...
                          <div className={styles.view_listing}>
                            <ul>
                              <li>
                                ...
                                <div className={styles.viewlable_info} id="AccountManager">
                                </div>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div className={styles.view_listing}>
                            <ul>
                              <li>
                                ...
                                <div className={styles.viewlable_info} id="BusinessManager">
                                </div>
                              </li>
                            </ul>
                          </div>
                  ...
                  <div id="ClientAndBilling" style={{ display: 'block' }}>
                    ...
                    <div className="row ${styles.sectionEnd}">
                      ...
                      <div className="col-md-4">
                        <div className={styles.form_group}>
                          <Label className={styles.lablecontrol}>Client Contact: <span
                            className={styles.estric}>*</span>
                          </Label>
                          <input className={styles.form_control} type="text" placeholder="Client Contact"
                            id="ClientContract"></input>
                          <Label className={styles.errorlable} id="ClientContractErr" style={{ display: 'none' }}
                          >This field is required.</Label>
                        </div></div>

                      <div className="col-md-4">
                        <div className={styles.form_group}>
                          <Label className={styles.lablecontrol}>Client E-Mail: <span className={styles.estric}>*</span>
                          </Label>
                          <input className={styles.form_control} type="text" placeholder="Client E-Mail"
                            id="ClientEMail"></input>
                          <Label className={styles.errorlable} id="ClientEMailErr" style={{ display: 'none' }}
                          >This field is required.</Label>
                          <Label className={styles.errorlable} id="ClientEMailErr2" style={{ display: 'none' }}
                          >Invalid email address!</Label>
                        </div></div>

                      <div className="col-md-4">
                        <div className={styles.form_group}>
                          <Label className={styles.lablecontrol}>Contact Number: <span
                            className={styles.estric}>*</span>
                          </Label>
                          <input className={styles.form_control} type="number" placeholder="ContactNumber"
                            id="ContactNumbers"></input>
                          <Label className={styles.errorlable} id="ContactNumberErr" style={{ display: 'none' }}
                          >This field is required.</Label>
                          <Label className={styles.errorlable} id="ContactNumberErr2" style={{ display: 'none' }}
                          >Minimum 10 digits or Maximum 15 digits allowed.</Label>
                        </div></div>
                  ...
                  <div id="DeliveryCommitments" style={{ display: 'block' }}>
                    ...
                    <div className="row ${styles.Dept}">
                      <div className="col-md-6 ${styles.Dept}">
                        <div className={styles.form_group}>
                          <h4 className={styles.subheading4}>3.1 Commitments made to Customer (By Marketing – only those not
                            mentioned
                            in the contract. by PMO by referring Contract)
                          </h4>
                        </div></div>
                        <div className="col-md-6">
                        <div className={styles.form_group}>
                          <h4 className={styles.subheading4}>3.2 Risks and Issues</h4>
                        </div></div>
                    </div>
                    ...
                    <div className="row ${styles.Dept}">
                      <div className="col-md-6 ${styles.Dept}">
                        <div className={styles.form_group}>
                          <Label className={styles.lablecontrol}>By marketing: <span className={styles.estric}>*</span>
                          </Label>
                          <textarea className={styles.form_control} placeholder="By marketing" rows={4} cols={50}
                            id="Bymarketing"></textarea>
                          <Label className={styles.errorlable} id="BymarketingErr" style={{ display: 'none' }}
                          >This field is required.</Label>
                        </div></div>

                      <div className="col-md-6">
                        <div className={styles.form_group}>
                          <Label className={styles.lablecontrol}>Risks and Issues: <span
                            className={styles.estric}>*</span>
                          </Label>
                          <textarea className={styles.form_control} placeholder="By marketing" rows={4} cols={50}
                            id="RisksandIssues"></textarea>
                          <Label className={styles.errorlable} id="RisksandIssuesErr" style={{ display: 'none' }}
                          >This field is required.</Label>
                        </div></div>
                  ...
                  <div className="row">
                    <div className="col col-md-6">
                      <div className={styles.form_group}>
                        <div className={styles.mb_1}><input type="file" className={styles.form_control} id="uploadFile"></input>
                          <span id="fileErr1" style={{ display: 'block' }} className={styles.errorlable} >Please select file to upload.</span>
                        </div>
                      </div></div>
                      ...
                      <div className={styles.form_group}>
                        <div className={styles.mb_1}>
                          <DefaultButton className="fileUpload-Button ${styles.btn} btn-primary">
                            <span className="" onClick={() => this.uploadFileFromControl1()}>Upload</span>
                          </DefaultButton>
                        </div></div>
                    </div>
                  </div>
                  ...
                  <div id="SubmittedModal" className={styles.modal}>
                    <div className={styles.modalcontent}>
                      ...
                      <Label className={styles.header2}>Feedback Submitted!
                      </Label>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col col-lg-12">
                      <div className={styles.form_footer}>
                        <PrimaryButton text="Submit" className={styles.btn} style={{ borderRadius: "10px", marginRight: "10px" }} id="Submit" onClick={() => this.CMSubmit()}></PrimaryButton>
                        <PrimaryButton text="Cancel" className={styles.btn} style={{ borderRadius: "10px" }} id="Cancel" onClick={() => this.CMCancel()}></PrimaryButton>
                      </div>
                    </div>
                  </div>
    ...
    return web.lists.getByTitle("Currency").items.getAll().then((response) => {
      return response;
    });
  }
    ...
    items.forEach((item: any) => {
        ...
        html1 += '<lable class="' + lablecontrol + '">Currency: <span class="'+Errorastrict+'">*</span></lable>'
        + '<select name="Currency" class="' + Select + '" id="Currency">'+html+'</select>'
        + '<lable class="' + errorlable + '" id="CurrencyErr" style="display:none; ">"This field is required."</lable>';
    ...
    const itemID = new URLSearchParams(window.location.search).get('itemid');
        ...
        let web = Web(this.props.webURL);
        web.lists.getByTitle("PINote").items.add({
    ...
    var mailformt = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1, 3}\.[0-9]{1, 3}\.[0-9]{1, 3}\.[0-9]{1, 3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
    ...
    var EstimatedHours = Number($(".EstimatedHours")[0].innerText);
      ...
      setTimeout(() => {$('#loader').hide(); }, 1000);
          ...
          let web = Web(this.props.webURL);
          var hostUrl = '/sites/demo/ProjectDocuments/' + $('#oppID').text();
    web.getFolderByServerRelativeUrl(hostUrl).files.filter("Title eq 'Project Related Document from CM'").get().then(files => {
      if (files.length == 0) {
            $("#filesList").empty();
      }
          else {
        for (var i = 0; i < files.length; i++) {
          ...
          attachmentfiles += `<li id="FileListItem` + i + `" value=` + valu + `><button class="CloseBtn"`
            + `id="CloseBtn" style="padding: 0;">&times;</button><lable style="display:none;">` + files[i].UniqueId + `</lable>`
          ...
          + `<a href="${files[i].ServerRelativeUrl}" target="_blank" id="FileName` + i + `">`
            + `${files[i].Name}</a></li>`;
            (document.getElementById('filesList') as HTMLInputElement).innerHTML = attachmentfiles;
    ...
    const itemID = new URLSearchParams(window.location.search).get('itemid');
          let web = Web(this.props.webURL);
    await web.lists.getByTitle("Projects").items.getById(parseInt(itemID)).select('*', 'AccountManager/Title', 'ProjectManager/Title').expand('ProjectManager/Id', 'AccountManager/Id').get().then((item) => {
    ...
    const itemID = new URLSearchParams(window.location.search).get('itemid');
          let web = Web(this.props.webURL);
          var _this = this;
    await web.lists.getByTitle("Projects").items.getById(parseInt(itemID)).select('Id', 'Status', 'OpportunityID').get().then((data) => {
    ...
    var filterStr = "OpportunityID eq '" + $('#oppID').text() + "'";
          let web = Web(this.props.webURL);
    await web.lists.getByTitle("CRMProjects").items.filter(filterStr).get().then((data) => {
