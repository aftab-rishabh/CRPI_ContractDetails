                  ...
                  <div className="col col-lg-12">
                    <div className={styles.form_group}>
                      ...
                      <div className={styles.mb_1}>
                        <PrimaryButton id="UploadDocs" text="Upload" className={[styles.btn]['btn-info']} onClick={() => this.uploadFileFromControl()} >
                        </PrimaryButton>
                      </div>
      ...
      if (files.length !== 0) {
        for (var i = 0; i < files.length; i++) {
          ...
          attachmentfiles += `<li id="FileListItem` + i + `" value=` + valu + `><button className="CloseBtn"`
            + `id="CloseBtn" style="display:none;padding: 0;">&times;</button><Label style="display:none;">` + files[i].UniqueId + `</Label>`
