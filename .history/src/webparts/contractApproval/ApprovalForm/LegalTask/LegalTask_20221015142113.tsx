...
<Label className={styles.headers}><u>Legal Feedback Form</u></Label>
  ...
  <div id=""className="row">
    ...
    <div className={styles.form_group}>
        ...
        <div className={styles.mb_1}><button className="fileUpload-Button {styles.btn} btn-info">
  ...
  <div id="loader" className={styles.modal}>
            ...
            <div className="row">
              <div className="col col-lg-12 {styles.form_footer}">
                <PrimaryButton text="Draft" className={styles.btn} style={{ display: 'inline-block' }} id="LegalDraft"   onClick={() => this.LegalDraft()} >Save as Draft</PrimaryButton>
                <PrimaryButton text="Submit" className={styles.btn} id="LegalSubmit"   onClick={() => this.LegSubmitData()}></PrimaryButton>
                <PrimaryButton text="Cancel" className={styles.btn} id="LegalCancel"   onClick={() => this.LegCancelForm()}></PrimaryButton>
              </div>
            </div>
