...
export class ManagementConsentTask extends React.Component<IManagementConsentTaskProps, IManagementConsentTaskState> {
  ...
  private viewItem(): void {
    ...
    web.lists.getByTitle("Projects").items.getById(parseInt(itemID)).select('*', 'AccountManager/Title', 'ProjectManager/Title').expand('ProjectManager/Id', 'AccountManager/Id').get().then((item) => {
