...
const collapsedIcon: IIconProps = { iconName: 'ChevronRight', className: styles.TechnicalChevron };
const expandedIcon: IIconProps = { iconName: 'ChevronDown', className: styles.TechnicalChevron };
...
export class Technical extends React.Component<ITechnicalProps, ITechnicalState> {
  ...
  public render(): React.ReactElement<ITechnicalProps> {
    return (
      <div className={css(styles.Technical, this.props.className)}>
        <div >
        <DefaultButton
          toggle
