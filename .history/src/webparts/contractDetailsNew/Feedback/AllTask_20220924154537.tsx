      ...
      <div className={styles.Feedback}>
        <div className={styles.container}>
          ...
          <div className={styles.row} style={{ paddingBottom: 0 }}>
            ...
            <div className={styles.viewdetail_block} style={{ paddingBottom: '10px' }}>
            ...
            <div id="loader" className={styles.modal} >
              <div className="">
                <div className={styles.loader} style={{ marginTop: '200px', marginBottom: '200px', marginLeft: 'auto', marginRight: 'auto' }}></div>
              </div>
            </div>
            <div id="ContractDeletedModal" className={styles.modal}>
              <div className={styles.modalcontent}>
                <span className={styles.close} onClick={() => this.Close0()} >&times;</span>
  ...
  private async setData() {
    ...
    await web.lists.getByTitle("Projects")
      .items.getById(parseInt(itemID)).select('*', 'Author/Id', 'Author/EMail', 'DeliveryManager/Title', 'AccountManager/Title').expand('DeliveryManager/Id', 'AccountManager/Id', 'Author/EMail').get().then(async (item) => {
        ...
        if (currentuseremail.toLowerCase() == CreatedEmail.toLowerCase() || currentuseremail.toLowerCase() == "spadmin@rishabhsoft.com") {
          this.setState({
