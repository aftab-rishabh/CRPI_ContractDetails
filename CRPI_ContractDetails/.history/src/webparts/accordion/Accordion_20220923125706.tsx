...
<div className={styles.sectionblock}>
    ...
    <li>{title}&nbsp-&nbsp<a href={item.ServerRelativeUrl} target="_blank">{item.Name}</a></li>
...
<div className={styles.section_right}>
  ...
  private getFiles() {
    ...
    sp.web.getFolderByServerRelativeUrl(hostUrl).files.get().then(files => {
      ...
      this.setState({
        ...
        //     if (title != "Management" && title != "Contract - Commercial") {
